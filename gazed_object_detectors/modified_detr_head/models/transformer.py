...
class Transformer(nn.Module):
    ...
    def forward(self, src1, src2, mask1, mask2, query_embed, pos_embed1, pos_embed2):
        ...
        pos_embed = torch.cat((pos_embed1, pos_embed2), 0)
...
def build_transformer(config):
    config_transformer = config["model"]["transformer"]
    return Transformer(**config_transformer)
